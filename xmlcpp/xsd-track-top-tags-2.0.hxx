...
#ifndef XSD_TRACK_TOP_TAGS_2_0_HXX
#define XSD_TRACK_TOP_TAGS_2_0_HXX
...
namespace LastFMAPITrackTopTags
{
  class lfm: public ::xml_schema::type
  {
    ...
    // toptags
    // 
    typedef ::LastFMAPITrackTopTags::toptags toptags_type;
  ...
  class toptags: public ::xml_schema::type
  {
    ...
    // tag
    // 
    typedef ::LastFMAPITrackTopTags::tag tag_type;
    ...
    // track
    // 
    typedef ::xml_schema::string track_type;
    typedef ::xsd::cxx::tree::optional< track_type > track_optional;
    typedef ::xsd::cxx::tree::traits< track_type, char > track_traits;

    const track_optional&
    track () const;
    ...
    void
    track (const track_type& x);

    void
    track (const track_optional& x);

    void
    track (::std::auto_ptr< track_type > p);
...
#endif // XSD_TRACK_TOP_TAGS_2_0_HXX
