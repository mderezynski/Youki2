...
#ifndef XSD_ARTIST_SIMILAR_2_0_HXX
#define XSD_ARTIST_SIMILAR_2_0_HXX
...
namespace lfm_similarartists
{
  class lfm: public ::xml_schema::type
  {
    ...
    void
    similarartists (const similarartists_type& x);

    void
    similarartists (::std::auto_ptr< similarartists_type > p);
    ...
    private:
    ::xsd::cxx::tree::one< similarartists_type > similarartists_;
  ...
  class similarartists: public ::xml_schema::type
  {
    ...
    // artist
    // 
    typedef ::xml_schema::ncname artist1_type;
    typedef ::xsd::cxx::tree::traits< artist1_type, char > artist1_traits;
    ...
    void
    artist1 (const artist1_type& x);

    void
    artist1 (::std::auto_ptr< artist1_type > p);

    // Constructors.
    //
    similarartists (const artist1_type&);
    ...
    ::xsd::cxx::tree::one< artist1_type > artist1_;
  };
  ...
  class artist: public ::xml_schema::type
  {
    ...
    // match
    // 
    typedef ::xml_schema::decimal match_type;
    typedef ::xsd::cxx::tree::traits< match_type, char > match_traits;
    ...
    ::xsd::cxx::tree::one< match_type > match_;
...
#endif // XSD_ARTIST_SIMILAR_2_0_HXX
