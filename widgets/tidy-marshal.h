...
/* VOID:POINTER (./tidy-marshal.list:4) */
#define _tidy_marshal_VOID__POINTER	g_cclosure_marshal_VOID__POINTER

/* VOID:UINT (./tidy-marshal.list:5) */
#define _tidy_marshal_VOID__UINT	g_cclosure_marshal_VOID__UINT

/* VOID:UINT,UINT (./tidy-marshal.list:6) */
...
/* VOID:OBJECT,OBJECT (./tidy-marshal.list:7) */
...
/* VOID:STRING,OBJECT (./tidy-marshal.list:8) */
extern void _tidy_marshal_VOID__STRING_OBJECT (GClosure     *closure,
                                               GValue       *return_value,
                                               guint         n_param_values,
                                               const GValue *param_values,
                                               gpointer      invocation_hint,
