...
///////////////////////
	...
	)
	{
	    ...
	    Gdk::Cairo::set_source_rgba(cairo, selected?c5:Util::make_rgba(0,0,0,1)) ;
		...
		cairo->save() ;
		Gdk::Cairo::set_source_rgba(cairo, Util::make_rgba(selected?c5:Util::make_rgba(0,0,0,.95),selected?.80:.5)) ;
		cairo->rectangle(
		      5
		    , 38
		    , 247  
