/***************************************************************************
    ...
    email                : wheeler@kde.org, mderezynski@gmail.com
 ***************************************************************************/
...
namespace TagLib {
  ...
  public:
    ...
    /*!
     * Returns the URI in UTF-8 encoding
     */
    virtual char const* uri() const;
     ...
     */
    virtual long find(const ByteVector &pattern,
              long fromOffset = 0,
     ...
     * than the buffer size used by readBlock().  Currently this is 1024 bytes.
     */
    virtual long rfind(const ByteVector &pattern,
               long fromOffset = 0,
               const ByteVector &before = ByteVector::null);
