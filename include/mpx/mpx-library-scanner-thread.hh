...
#include "mpx/exception.hh"
	...
	class LibraryScannerThread : public sigx::glib_threadable
	{
        public:
            ...
            typedef sigc::signal<void, guint>                      SignalNewAlbum_t ;
            typedef sigc::signal<void, guint>                      SignalNewArtist_t ;
            typedef sigc::signal<void, Track&, guint, guint>      SignalNewTrack_t ;
            typedef sigc::signal<void, Track&, guint, guint>      SignalTrackUpdated_t ;
...
/////////////////////////
            ...
            typedef std::map<FileTriplet_t, guint>                            Triplet_MTIME_t;
